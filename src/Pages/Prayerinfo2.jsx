    ...
    <Container maxWidth="md" sx={{ py: 5 }}>
      ...
      <Paper elevation={3} sx={{ p: 3, mb: 4 }}>
        ...
        <Typography variant="body1" sx={{ fontSize: "1.1rem" }}>
          صلاة الظهر هي ثاني الصلوات المفروضة في اليوم، وتتكون من{" "}
          <strong>أربع ركعات</strong> تُؤدى سرًا. يبدأ وقتها من{" "}
          <strong>زوال الشمس</strong> عن وسط السماء إلى أن يصير{" "}
          <strong>ظل كل شيء مثله</strong>، ويمتد إلى دخول وقت العصر.
        </Typography>
      </Paper>
      ...
      <Paper elevation={3} sx={{ p: 3, mb: 4 }}>
        ...
        <Typography variant="body1" sx={{ fontSize: "1.1rem", lineHeight: 2 }}>
          • من أعظم الصلوات التي يُستجار فيها بالله من النار.
          <br />• قال ﷺ: <em>«ثم صلِّ، فإن الصلاة مشهودة»</em>
          <br />• قال ﷺ:{" "}
          <em>"أما صلاة الظهر إذا زالت الشمس، يسبح كل شيء لربه..."</em>
          <br />
          • نور في الدنيا والآخرة، ومكفرة للسيئات.
          <br />•{" "}
          <em>
            «من صلى أربعًا قبل الظهر وأربعًا بعدها حرّمه الله على النار»
          </em>{" "}
          – الترمذي
          <br />
          • هي أول صلاة فرضت بعد المعراج.
          <br />• أداؤها وقت اللهو علامة على الإيمان:{" "}
          <em>﴿إن الصلاة كانت على المؤمنين كتابًا موقوتًا﴾</em>
        </Typography>
      </Paper>
      ...
      <Paper elevation={3} sx={{ p: 3, mb: 4 }}>
        ...
        <Typography variant="body1" sx={{ fontSize: "1.1rem", lineHeight: 2 }}>
          ...
          • السنة الراتبة: ركعتان أو أربع قبلها، وركعتان بعدها.
          <br />• عن عائشة:{" "}
          <em>"كان لا يدع أربعًا قبل الظهر وركعتين قبل الغداة"</em>.
        </Typography>
      </Paper>
      ...
      <Paper elevation={3} sx={{ p: 3, mb: 4 }}>
        <Typography
          variant="h5"
          gutterBottom
          sx={{ fontWeight: "bold", mt: 4, color: "#ef6c00" }}
        >
        ...
        <Box component="ul" sx={{ pl: 3, lineHeight: 2, fontSize: "1.1rem" }}>
          ...
          <li>
            الركوع: <em>"سبحان ربي العظيم"</em> ثلاثًا.
          </li>
          <li>
            الرفع من الركوع: <em>"سمع الله لمن حمده، ربنا ولك الحمد"</em>.
          </li>
          <li>سجدتان مع الدعاء بينهما.</li>
          <li>التشهد بعد الركعتين الأوليين.</li>
          <li>الركعتان الثالثة والرابعة بالفاتحة فقط.</li>
          <li>التشهد الأخير، ثم التسليم يمينًا ويسارًا.</li>
        </Box>
      </Paper>
      {/* الأذكار بعد الصلاة */}
      <Paper elevation={3} sx={{ p: 3, mb: 4 }}>
        ...
        <Box component="ul" sx={{ pl: 3, lineHeight: 2, fontSize: "1.1rem" }}>
          <li>
            الاستغفار ثلاثًا: <em>"أستغفر الله، أستغفر الله، أستغفر الله"</em>.
          </li>
          <li>
            <em>"اللهم أنت السلام ومنك السلام..."</em>.
          </li>
          <li>
            قراءة <strong>آية الكرسي</strong>:{" "}
            <em>﴿اللّهُ لاَ إِلَـهَ إِلاَّ هُوَ الْحَيُّ الْقَيُّومُ...﴾</em>
          </li>
