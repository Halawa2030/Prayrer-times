    ...
    <Container maxWidth="md" sx={{ py: 5 }}>
      ...
      <Paper elevation={3} sx={{ p: 3, mb: 4 }}>
        ...
        <Typography variant="body1" sx={{ fontSize: "1.1rem" }}>
          يبدأ وقت صلاة الفجر من انشقاق الفجر الصادق إلى طلوع الشمس. يُستحب
          التغليس؛ أي أداؤها في أول وقتها. <br />
          قال النبي ﷺ:{" "}
          <em>
            "مَن أَدْرَكَ مِنَ الصُّبْحِ رَكْعَةً قَبْلَ أَنْ تَطْلُعَ
            الشَّمْسُ، فقَدْ أَدْرَكَ الصُّبْحَ"
          </em>
          .
        </Typography>
      </Paper>
      ...
      <Paper elevation={3} sx={{ p: 3, mb: 4 }}>
        ...
        <Typography variant="body1" sx={{ fontSize: "1.1rem" }}>
          ...
          يُستحب في الفريضة قراءة سور طويلة، وفي السنة قراءة{" "}
          <strong>سورة الكافرون</strong> في الركعة الأولى، و
          <strong>سورة الإخلاص</strong> في الثانية.
        </Typography>
      </Paper>
      ...
      <Paper elevation={3} sx={{ p: 3, mb: 4 }}>
        ...
        <Typography variant="body1" sx={{ fontSize: "1.1rem", lineHeight: 2 }}>
          ...
          <br />
          • سبب لدخول الجنة
          <br />• ركعتا السنة خير من الدنيا وما فيها
        </Typography>
      </Paper>
      ...
      <Paper elevation={3} sx={{ p: 3, mb: 4 }}>
        ...
        <Typography variant="body1" sx={{ fontSize: "1.1rem", lineHeight: 2 }}>
          • نور تام يوم القيامة لمن يمشي في الظلام إلى المسجد
          <br />
          • شهادة الملائكة لصلاة الفجر
          <br />
          • فيها حفظ من الله طول اليوم
          <br />• من حافظ عليها دخل الجنة
        </Typography>
      </Paper>
      ...
      <Paper elevation={3} sx={{ p: 3, mb: 4 }}>
        <Typography
          variant="h5"
          gutterBottom
          sx={{ fontWeight: "bold", mt: 4, color: "#6a1b9a" }}
        >
        ...
        <Box component="ul" sx={{ pl: 3, lineHeight: 2, fontSize: "1.1rem" }}>
          ...
          <li>
            تكبيرة الإحرام وقول: <strong>"الله أكبر"</strong>.
          </li>
          <li>وضع اليد اليمنى على اليسرى فوق الصدر.</li>
          <li>دعاء الاستفتاح ثم الفاتحة وسورة بعدها جهرًا.</li>
          <li>
            الركوع وقول: <strong>"سبحان ربي العظيم"</strong> ثلاثًا.
          </li>
          <li>
            الرفع من الركوع:{" "}
            <strong>"سمع الله لمن حمده - ربنا ولك الحمد"</strong>.
          </li>
          ...
          <li>
            <strong>ملاحظة:</strong> الخشوع واستحضار القلب أساس الصلاة.
          </li>
        </Box>
      </Paper>
      {/* البشائر العشر */}
